...
> 我承认，起初我是怀疑者。我发现，似可信程度往往与一个人对主题的了解成反比。早期模型尽管流利，却像带着「冒充者综合征」，为可信度而非正确性优化。但随后出现了拐点——由新一代「推理」模型带来的阶跃。突然间，我们不再只是与预测下一个词的统计机器对话，而是在窥见一种初生的认知形态。
...
> 我第一次试用新的智能体化编程工具时，又感受到那种熟悉的魔法火花。我让它做一项我一直没时间做的私事：把慈善网站从简单建站工具迁移到规范的现代 CI/CD 环境。接下来二十分钟里，它提问澄清、请求凭据、汇报进度——不像在用工具，更像与初级开发者协作。当它交出可完整部署的包，附带无可挑剔的文档与单元测试时，我彻底折服。
...
> 当然，它并不完美：会犯错、会卡住，需要我的监督，更关键的是我的判断来把它拉回正轨。这段经历再次印证我职业生涯里艰难学到的一课：绝不能盲信。然而过程令人着迷。窥视其「思维链」如同观察心智运作——杂乱、非线性，充满停顿、重启与自纠，与人类推理并无二致；不是直线，而是走向解的随机游走。这里有一种新事物的内核：不仅能生成内容，还能生成*计划*。
...
> 这就是智能体化框架的承诺：如同静态地铁图与能实时改道的动态 GPS 之别。经典规则自动机沿固定路径走，遇意外障碍便崩溃；由推理模型驱动的 AI 智能体则能观察、适应并另寻路径。它具备某种数字常识，能在现实的无数边角情形中穿行。这标志着从只告诉计算机*做什么*，转向解释*为何*要做、并信任它找出*如何做*。
...
> 这片新前沿令人振奋，也带来深重责任——以我作为全球金融机构 CIO 的视角尤其如此。赌注高得无法衡量。智能体在写「鸡肉三文鱼融合派」菜谱时犯错是趣闻；在执行交易、管理风险或处理客户数据时犯错则是真问题。我读过免责声明与警示故事：某网页自动化智能体登录失败后，竟发邮件给国会议员抱怨登录墙——黑色幽默地提醒我们：面对的是我们尚未完全理解的技术。
...
> 在此，工艺、文化与对原则的不懈坚持成为必要指南。我们的工程信条并非纸上文字，而是指南针。我们必须*有目的地构建*，确保每个智能体设计都始于对客户问题的清晰理解；必须*预见转角*，预见失效模式并设计天生韧性的系统；最重要的是必须*激发信任*，对方法透明、对结果负责。
...
> 在智能体化的世界里，这些信条更为紧迫。残酷事实是：你不能把强大的新工具简单叠加在混乱、不一致的系统上却期待好结果——混乱系统加智能体等于灾难。在「垃圾」数据上训练的 AI 不只输出垃圾，还会输出似可信、自信满满的垃圾，毒害整个流程。因此首要且最关键的任务是整地：投资干净数据、一致元数据与定义良好的 API；建设现代「州际系统」，让这些智能体安全高速运行。这是艰苦、基础性的工作：打造可编程企业、「软件即企业」，使流程与代码一样架构良好。
...
> 归根结底，这段旅程不是取代人类才智，而是增强它。它要求我们所有人掌握新技能：清晰说明任务、明智委托、勤勉验证输出质量；要求我们谦逊、承认未知、永不停止学习。本书后续页码提供构建这些新框架的技术地图。我希望你不仅用它们建造「可能之事」，更建造「正确、稳健、负责任」之物。

The world is asking every engineer to step up. I am confident we are ready for the challenge.

> 世界正在召唤每一位工程师。我相信我们已准备好迎接挑战。
