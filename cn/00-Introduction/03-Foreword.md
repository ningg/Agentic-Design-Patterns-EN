...
> 正如本书恰如其分地概括，这些「智能体化」系统代表了 AI 的下一前沿；其开发是一项令我们 Google 团队既兴奋又备受鼓舞的挑战。
...
> 我们致力于为开发者提供最强、最灵活的画布，以构建下一代 AI 应用。
> 本书提供贴近实践的指引，帮助开发者充分发挥这一画布的潜力；
> 从提示链、工具使用到智能体间协作、自校正、安全与护栏，本书为希望构建复杂 AI 智能体的开发者提供了全面的工具箱。
...
> 《Agentic Design Patterns》是释放这种创造力不可或缺的资源；
